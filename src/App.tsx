...
import { StudyPlansPage } from './pages/StudyPlansPage'; // Import StudyPlansPage
...
const App: React.FC = () => {
  ...
  const isStudyPlansPage = location.pathname === '/study-plans';
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-light-bg text-text-primary">
      ...
      <main className={mainContentClasses}>
        ...
        <Routes>
          ...
          <Route path="/study-plans" element={<StudyPlansPage />} /> {/* Add StudyPlansPage route */}
